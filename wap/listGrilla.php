...
?>
<th colspan="<?php echo $nro_cam;?>">OPERACIONES</th>
</tr>
<?php
...
<?php
	...
	foreach($datoOperaciones as $operacion){
		...
		?>
<td><?php if($operacion["idoperacion"]!=$_GET['ocultaope']){?><a href="#" title="<?php echo umill($operacion["comentario"]);?>" onClick="javascript:<?php echo umill($operacion["accion"]);?>(<?php echo $dato[1];?>);"><?php echo umill($operacion["descripcion"]);?></a><?php }?></td>
		<?php
			}
		}
	}
