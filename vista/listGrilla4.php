...
<?php
	...
	foreach($datoOperaciones as $operacion){
        ...
        <button <?php echo $operacion["idoperacion"];?> type="button" style="margin-left: 10px;" 
            ...
            onClick="javascript:<?php echo umill($operacion["accion"]);?>(<?php echo $dato[1];?>,<?php echo $dato[2];?>,<?php echo $dato[3];?>,<?php echo $dato[4];?>);"><i class="material-icons <?php echo $operacion["color"];?>-text text-darken-4"><?php echo $operacion["imagen"];?></i></button>
		<?php
		}
	}
?>          </div>
