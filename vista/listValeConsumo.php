...
function buscar(){
	...
	vBy = document.getElementById("by").value;
        comida='N';
	vValor = "'"+vOrder + "'," + vBy + ", 0,<?php echo $id_cliente;?>, '" + document.getElementById("txtBuscar_Apellido_Nombre").value + "','" + document.getElementById("txtFechaInicio").value + "','" + document.getElementById("txtFechaFin").value + "','" + document.getElementById("cbocompartido").value + "','" + document.getElementById("cbotipo").value + "','',''" + "," + document.getElementById('cboIdSalon').value+",'"+comida+"'";
        var formData = $("#frmBusqueda").serialize();
        setRun('vista/listGrillaValeConsumo',formData, 'grilla', 'grilla', 'img03');
...
<div class="Botones" id="opciones">
    <div class="row">
            <div class="col s12 center">
                <button class="tooltipped btn-large light-green accent-1 truncate light-green-text text-darken-4" type="button" data-position="bottom" data-delay="50" data-tooltip="NUEVO" onclick="javascript:setRun('vista/mantValeConsumo', 'accion=NUEVO&amp;id_clase=53', 'cargamant','cargamant', 'img04');$('#'+$(this).attr('data-tooltip-id')).remove();$('#tablaActual').hide();"><i class="material-icons right">note_add</i>NUEVO</button>
            </div>
    </div>
</div>
        ...
        <form id="frmBusqueda">
            ...
            <div class="col s12 m6 l2">
                <div class="input-field inline">
                    ...
                    <label for="txtBuscar_Apellido_Nombre">Propietario</label>
                </div>
            </div>
            <div class="col s12 m6 l2">
            ...
            <div class="col s12 m6 l3">
                <div class="input-field inline">
                    ...
                    ?>
                    <label class="black-text">Usuarios</label>
                </div>
            </div>
            <div class="col s12 m6 l2">
                <div class="input-field inline">
                    <select name="txtEstado" id="txtEstado">
                        ...
                        <option selected="" value="N">PENDIENTE</option>
                        <option value="C">CONSUMIDO</option>
