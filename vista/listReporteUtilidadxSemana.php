...
function buscar(){
	...
	setRun('vista/listGrillaSinOperacion','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Movimiento&id_clase=63&funcion=ReporteUtilidadxMesoxSemana&filtro=' + vValor + '&imprimir=SI&tiporeporte=DinamicoResumen&titulo=de Utilidad Bruta&origen=VentaxMesoxSemana&grafico=SI&datografico=semanames', 'grilla', 'grilla', 'img03');
}
