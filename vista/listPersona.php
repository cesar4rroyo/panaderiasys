...
function buscar(){
	...
	vValor = "'"+vOrder + "'," + vBy + ",0, 0, 0, '" + document.getElementById("txtBuscar_Apellido_Nombre").value + "','" + document.getElementById("txtBuscar_NroDoc").value + "','" + document.getElementById("cbosexo").value + "','" + document.getElementById("cbocompartido").value + "','','" + document.getElementById("cboTipoPersona").value + "','" + document.getElementById("txtFechaInicio").value + "','" + document.getElementById("txtFechaFin").value + "'";
	setRun('vista/listGrilla3','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Persona&id_clase=<?php echo $id_clase;?>&imprimir=SI&filtro=' + vValor, 'grilla', 'grilla', 'img03');
}
function ordenar(id){
...
function roles(idpersona, idsucursal, idpersonamaestro){
	setRun('vista/listRolPersona','&accion=ACTUALIZAR&clase=RolPersona&id_clase=15&IdSucursal=' + idsucursal + '&IdPersona=' + idpersona + '&IdPersonaMaestro=' + idpersonamaestro,'frame','carga','imgloading');
}
...
<div class="col s12 container Mesas" id="tablaActual">
    <div class="row" style="padding: 10px;margin-bottom: 0px;">
        <div class="col s12 FiltrosCajero" id="busqueda">
            ...
            <div class="col s12 m6 l2" style="display: none;">
