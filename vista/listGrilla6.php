	...
	foreach($datoOperaciones as $operacion){
		if($operacion["tipo"]=="C"){
                    if($operacion["idoperacion"]==2){
                            ...
                            $operacion["color"] = "green";
                    }elseif($operacion["idoperacion"]==5){
                            $operacion["imagen"] = "power_settings_new";
		...
		?>
                <button <?php echo $operacion["idoperacion"];?> type="button" style="margin-left: 10px;" 
                        ...
                        onClick="javascript:<?php echo umill($operacion["accion"]);?>(<?php echo $dato[1];?>,<?php echo $dato[2];?>,<?php echo $dato[3];?>,'<?php echo $dato[4];?>',<?php echo $dato[5];?>,'<?php echo $dato[6];?>');">
                    <i class="material-icons <?php echo $operacion["color"];?>-text text-darken-4"><?php echo $operacion["imagen"];?></i>
                </button>
		<?php
		}
	}
