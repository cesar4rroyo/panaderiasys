...
function buscar(){
	...
	setRun('vista/listGrillaSinOperacion','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Producto&id_clase=<?php echo $id_clase;?>&filtro=' + vValor + '&imprimir=SI&tiporeporte=ProductoAgrupado&titulo=Producto', 'grilla', 'grilla', 'img03');
}
function ordenar(id){
        ...
        <div class="col s12 FiltrosCajero" id="busqueda">
            ...
            <div class="col s12 m6 l2">
                <div class="input-field inline">
                    ...
                    <label for="txtFechaInicio" class="active">Fecha Venc. Inicial</label>
                </div>
            </div>
            <div class="col s12 m6 l2">
                <div class="input-field inline">
                    ...
                    $fecha = explode('/',$_SESSION['R_FechaProceso']);
                    echo $fecha[2]."-".$fecha[1]."-".$fecha[0];?>">
                    <label for="txtFechaFin" class="active">Fecha Venc. Final</label>
                </div>
            </div>
            <div class="col s12 m6 l1">
                <div class="input-field inline">
