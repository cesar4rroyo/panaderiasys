...
function buscar(){
	...
	vValor = "'"+vOrder + "'," + vBy + ", 0, 2, '" + document.getElementById("txtBuscar").value + "','','" + document.getElementById("txtFechaInicio").value + "','" + document.getElementById("txtFechaFin").value + "',0,'S'";
	//SI SE AGREGA MAS ARGUMENTOS, MODIFICAR EL FILTRO EN ReporteVentaResumen
	setRun('vista/listGrillaSinOperacion','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Movimiento&id_clase=63&funcion=ReporteUtilidadNetaxMesoxSemana&filtro=' + vValor + '&imprimir=SI&tiporeporte=DinamicoResumen&titulo=de Utilidad Neta&origen=VentaxMesoxSemana&grafico=SI&datografico=semanames', 'grilla', 'grilla', 'img03');
}
        ...
        <div class="col s12 FiltrosCajero" id="busqueda">
            <div class="col s12 m6 l1" hidden="">
                <div class="input-field inline">
                    ...
                    <label for="txtBuscar">Descrip.</label>
                </div>
            </div>
