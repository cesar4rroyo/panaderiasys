...
$serieHoy = date("Ymd");
$series = $mdlSerie->verSeries3($_SESSION["empresa"]["id_empresa"], "A",$serieHoy);
...
<section>
    ...
    <div class="row contenido">
        <form id="frmRegistrarFactura" action="controlador/contComprobante.php?funcion=enviarComunicacionBajas">
                    ...
                    <table class="striped centered bordered detallesCuerpo">
                        <thead>
                            <tr>
                                ...
                                <th>NUMERACION</th>
                                <th>MOTIVO</th>
                                <th><i class="material-icons" onclick="/*agregarNuevoDetalle();*/anadirDetalle2();">add</i></th>
                            </tr>
                        </thead>
...
<script>
    //agregarRuta(true,"Registrar Comunicacion Bajas","frmComunicacionBajasF.php");
    ...
    function actualizarDocumento(fila){
        ...
        autocompleteAJAX_JSON("controlador/contComprobante.php","funcion=listarComunicacion&estado=T,C,M&id_empresa=<?php echo $_SESSION["empresa"]["id_empresa"];?>&fecini="+fecharef+"&tipodoc="+tipoDoc,"",["serie + '|' + '"+numero+"'","correlativo","id_solicitud","id_solicitud_servidor"],"numeracion","divNumeracion_"+numero,"numeracion[]","numeracion_"+numero,seleccionarDocumento,"","autocomplete-content3","");
    }
    ...
    function seleccionarDocumento(iddocumento){
        ...
        $("#numeracion_"+fila).before('<span style="margin-top: 10px;" class="caret pointer" onclick="$(\'#serieDetalle_'+fila+'\').val(\'\');$(\'#corrDetalle_'+fila+'\').val(\'\');$(\'#idDetalle_'+fila+'\').val(\'\');limpiarAutocomplete(\'numeracion_'+fila+'\',\'id_numeracion\',$(this));"><i class="material-icons red-text" style="">clear</i></span>');
