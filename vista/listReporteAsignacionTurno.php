...
function buscar(){
	...
	setRun('vista/listGrillaSinOperacion','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=AsignacionTurno&id_clase=<?php echo $id_clase;?>&filtro=' + vValor + '&imprimir=SI&tiporeporte=AsignacionTurno&titulo=Turnos Asignados', 'grilla', 'grilla', 'img03');
}
function ordenar(id){
