...
function buscar(){
	...
	vValor = "'"+vOrder + "'," + vBy + ", 0,<?php echo $id_cliente;?>, '" + document.getElementById("txtBuscar_Descripcion").value + "','"+ document.getElementById("cbocategoria").value + "','" + document.getElementById("cbomarca").value + "','" + document.getElementById("txtFechaInicio").value + "','" + document.getElementById("txtFechaFin").value + "','" + document.getElementById("cbocompartido").value + "','" + document.getElementById("cbotipo").value + "'";
        
        var vValor2 = "vOrder,vBy,0,id_cliente,txtBuscar_Descripcion,cbocategoria,cbomarca,txtFechaInicio,txtFechaFin,cbocompartido,cbotipo";
	
        setRun('vista/listGrilla2Producto','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Producto&id_clase=<?php echo $id_clase;?>&imprimir=SI&filtro=' + vValor + '&nombrefiltro='+vValor2, 'grilla', 'grilla', 'img03');
    }
}
function ordenar(id){
...
buscar();
$('#txtBuscar_Descripcion').keyup(function(e){
    if(e.keyCode == 13)
    {
        buscar();
    }
        ...
        <div class="col s12 FiltrosCajero" id="busqueda">
            <div class="col s12 m6 l5">
                <div class="input-field inline">
                    <input id="txtBuscar_Descripcion" type="text" name="txtBuscar_Apellido_Nombre" value="<?php echo $_SESSION["R_filtrosbusqueda"]["txtBuscar_Descripcion"];?>">
            ...
            <div class="col s12 m6 l3">
                <div class="input-field inline">
                    ...
                    echo genera_cboGeneralSQL("Select vIdCategoria, vDescripcion as Descripcion from up_buscarcategoriaproductoarbol(".$_SESSION['R_IdSucursal'].") order by vDescripcion","categoria",$_SESSION["R_filtrosbusqueda"]["cbocategoria"],'',$objMantenimiento,'', 'Todos');
            ...
            <div class="col s12 m6 l3">
                <div class="input-field inline">
                    <?php
                    echo genera_cboGeneralSQL("Select * from Marca Where idsucursal=".$_SESSION['R_IdSucursal']." and Estado='N'","marca",$_SESSION["R_filtrosbusqueda"]["cbomarca"],'',$objMantenimiento, '', 'Todos');
                    ?>
                    <label>Marca</label>
                </div>
            </div>
