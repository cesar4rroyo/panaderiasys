...
function buscar(){
	...
	vBy = document.getElementById("by").value;
        comida='N';
	vValor = "'"+vOrder + "'," + vBy + ", 0,<?php echo $id_cliente;?>, '" + document.getElementById("txtBuscar_Descripcion").value + "','"+ document.getElementById("cbocategoria").value + "','" + document.getElementById("cbomarca").value + "','" + document.getElementById("txtFechaInicio").value + "','" + document.getElementById("txtFechaFin").value + "','" + document.getElementById("cbocompartido").value + "','" + document.getElementById("cbotipo").value + "','',''" + "," + document.getElementById('cboIdSalon').value+",'"+comida+"'";
        var formData = $("#frmBusqueda").serialize();
        setRun('vista/listGrillaProductosEliminados',formData, 'grilla', 'grilla', 'img03');
        ...
        <form id="frmBusqueda">
            ...
            <div class="col s12 m6 l3">
                <div class="input-field inline">
                    ...
                    <label for="txtBuscar_Descripcion">Producto</label>
                </div>
            </div>
            <div class="col s12 m6 l3">
                <div class="input-field inline">
