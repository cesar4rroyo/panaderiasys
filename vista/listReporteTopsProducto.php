...
function buscar(){
	...
	vValor = "'"+vOrder + "'," + vBy + ", 0,<?php echo $id_cliente;?>, '" + document.getElementById("txtBuscar_Descripcion").value + "','"+ document.getElementById("cbocategoria").value + "','" + document.getElementById("cbomarca").value + "','" + document.getElementById("txtFechaInicio").value + "','" + document.getElementById("txtFechaFin").value + "','" + document.getElementById("cbocompartido").value + "','" + document.getElementById("cbotipo").value + "',''," + document.getElementById('chkJornada').checked + "," + document.getElementById('cboIdSalon').value+",'"+comida+"'";
	if(document.getElementById('chkDetallado').checked==false){
		setRun('vista/listGrillaSinOperacionTops','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Producto&id_clase=<?php echo $id_clase;?>&funcion=Reporte&filtro=' + vValor + '&imprimir=SI&tiporeporte=Tops&titulo=Producto&datografico=codigo&fechainicio=' + document.getElementById("txtFechaInicio").value + '&fechafin=' + document.getElementById("txtFechaFin").value, 'grilla', 'grilla', 'img03');
	}else{
		setRun('vista/listGrillaSinOperacionTops','&nro_reg=<?php echo $nro_reg;?>&nro_hoja='+document.getElementById("nro_hoj").value+'&clase=Producto&id_clase=<?php echo $id_clase;?>&funcion=ReporteDetallado&filtro=' + vValor + '&imprimir=SI&tiporeporte=Tops&titulo=Producto Detallado&datografico=codigo&fechainicio=' + document.getElementById("txtFechaInicio").value + '&fechafin=' + document.getElementById("txtFechaFin").value, 'grilla', 'grilla', 'img03');
	}
}
function ordenar(id){
    ...
    <div class="row" style="padding: 10px;margin-bottom: 0px;">
        <div class="col s12 FiltrosCajero" id="busqueda">
            ...
            <div class="col s12 m3 l2">
                <div class="input-field inline">
                    <p>
                        <input type="checkbox" class="filled-in" id="chkComida" name="chkComida" onchange="vcomida=this.checked"/>
                    ...
                    <p>
                        <input type="checkbox" class="filled-in" id="chkDetallado" name="chkDetallado"/>
