...
<section>
    <div class="row titulo">
        <h4 class="center">REGISTRAR RESUMEN DE BOLETAS</h4>
    </div>
    <div class="row contenido">
        <form class="frmFiltros" id="frmFiltros" action="controlador/contComprobante.php?funcion=tablaResumenes" onsubmit="return false;">
            ...
            <input name="tipodoc" value="'B'" type="hidden">
        </form>
        <form id="frmRegistrarFactura" action="controlador/contComprobante.php?funcion=enviarResumenBoletas">
            <input type="hidden" name="tipoResumen" value="1">
            ...
            <div class="col s10 offset-s1 Factura">
                <div class="row">
                    ...
                    <div class="col s4 center datosEmisor">
                        ...
                        <h6 class="tipoDocCabecera">RESUMEN DE BOLETAS</h6>
                ...
                <div class="row">
                    <div class="col s3">
                        <div class="input-field">
                            ...
                            <label for="fecref" class="active">FECHA DE EMISION DE BOLETAS</label>
                        </div>
                    </div>
                    <?php /*
...
<script>
    //agregarRuta(true,"Registrar Resumen Boletas","frmResumenBoletas.php");
