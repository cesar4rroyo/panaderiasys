...
//echo $id_clase;
try{
$objMantenimiento = new clsColor($id_clase,$_SESSION['R_IdSucursal'],$_SESSION['R_NombreUsuario'],$_SESSION['R_Clave']);
...
if($_GET["accion"]=="ACTUALIZAR"){
	$rst = $objMantenimiento->consultarColor(1,1,'2',1,$_GET["Id"],$id_cliente,"");
	if(is_string($rst)){
...
CargarCabeceraRuta([["ACTUALIZAR - <?php echo umill($dato["numero"]);?>",'vista/mantColor','<?php echo $_SERVER["QUERY_STRING"];?>']],false);
<?php }else{?>
